...
<div class="container mt-5">
    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            ...
            <br/>
            <p><b><?= _('Description') ?></b> <?php echo $product->description; ?></p>
            <form action="/Cart/add/<?php echo $product->product_id; ?>" method="post">
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <button type="submit" name="cart" class="btn btn-success"> <?= _('Add to cart') ?></button>
                    </div>
                </div>
            </form>
            <a href="#sellerFeedback"><?= _('Give seller feedback') ?></a>&nbsp;&nbsp;
            <a href="/SellerProduct/report/<?php echo $product->product_id; ?>" onclick="return confirm('Are you sure want to report for this product')"><?= _('Report Listing') ?></a>
        </div>
    </div>
    <div class="row">
            <h5>Give a review </h5>
            <form action="/Review/create/<?php echo $product->product_id;?>" method="post" class="pb-3">
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <button type="submit" name="saveReview" class="btn btn-warning"><?= _('Submit your review') ?></button>
                    </div>
                </div>
            </form>
    ...
    <div class="row py-3" id="sellerFeedback">
        <h4><?= _('Give Seller Feedback') ?></h4>
        <form action="/Seller/feedbackSave/<?php echo $product->seller_id;?>/<?php echo $product->product_id;?>" method="post" class="pb-3">
            <div class="row">

                <div class="col-sm-12">
                    <textarea name="feedback" required class="form-control" placeholder="<?= _('Enter your feedback') ?>"></textarea>
                </div>
                <div class="col-sm-8 mt-3">
                    <button type="submit" name="saveFeedback" class="btn btn-warning"><?= _('Submit your feedback') ?></button>
                </div>
            </div>
        </form>
